...
import StarsBackground from "@/components/modules/background/StarsBackground";
...
export default function HomePage() {
  ...
  const codeExample: string = `curl -X POST https://api.starproof.io/v1/credentials \\
            ...
            {[
              ...
              >
                <Card className="p-8 bg-gray-900/50 backdrop-blur-sm border-gray-700 rounded-2xl hover:border-[#0066ff] transition-all duration-300 h-full">
                  <div className="text-[#7b4dff] text-lg font-semibold mb-4">
                    {item.step}
                  </div>
